...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('admin.magiamgia.xuat') }}" class="btn btn-success btn-sm">
...
<div class="modal fade" id="modalNhapExcel" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.magiamgia.nhap') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title"><i class="fas fa-upload me-2"></i>Nhập Mã Giảm Giá Từ Excel</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-info small mb-0">
                        ...
                        Hàng 1 là tiêu đề:<br>
                        <code>Mã code | Mô tả | Kiểu giảm | Giá trị | Đơn hàng tối thiểu | Giảm tối đa | Số lượng | Bắt đầu | Kết thúc | Kích hoạt</code><br>
                        <span class="text-danger mt-1 d-block">Kiểu giảm nhập: <strong>phan_tram</strong> hoặc <strong>co_dinh</strong></span>
                    </div>
                </div>
